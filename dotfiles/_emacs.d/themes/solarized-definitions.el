; Uses patch from this pull request:
; https://github.com/sellout/emacs-color-theme-solarized/pull/22
; The problem, in short, is that we have to tell emacs that we've
; remapped the tty's colors; otherwise it thinks they're the standard
; colors and mis-maps solarized's colors to the tty's colors.
